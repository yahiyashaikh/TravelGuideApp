...
class WindowBase(EventDispatcher):
    ...
    :Parameters:
        ...
        `allow_screensaver`: bool
            Allow the device to show a screens saver, or to go to sleep
    ...
    '''Whether the screens saver is enabled, or on mobile devices whether the
    ...
    def on_rotate(self, rotation):
        '''Event called when the screens has been rotated.
        '''
        pass
    ...
    '''Return the DPI of the screens as computed by the window. If the
