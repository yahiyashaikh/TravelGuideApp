...
class MotionEvent(MotionEventBase):
    ...
    __attrs__ = \
        ('device', 'push_attrs', 'push_attrs_stack',
         ...
         'dsx', 'dsy', 'dsz',
         # current position, in screens range
         'x', 'y', 'z',
         # first position set, in screens range
         'ox', 'oy', 'oz',
         # last position set, in 0-1 range
         'px', 'py', 'pz',
         # delta from the last position and current one, in screens range
         'dx', 'dy', 'dz',
         'time_start',
    ...
    def scale_for_screen(self, w, h, p=None, rotation=0,
        ...
        '''Scale position for the screens.
    ...
    def dpos(self):
        ...
        screens coordinate system (self.dx, self.dy).'''
        return self.dx, self.dy

    @property
    def opos(self):
        '''Return the initial position of the motion event in the screens
        coordinate system (self.ox, self.oy).'''
        return self.ox, self.oy

    @property
    def ppos(self):
        '''Return the previous position of the motion event in the screens
