...
* (x, y) - coordinates in pixels, mostly used for rendering on screens.
...
class TextInputCutCopyPaste(Bubble):
    ...
    def _check_parent(self, dt):
        # this is a prevention to get the Bubble staying on the screens, if the
        # attached textinput is not on the screens anymore.
