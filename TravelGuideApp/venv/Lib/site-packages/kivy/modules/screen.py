...
To see a list of the available screenid's, just run::
    ...
    python main.py -m screens

To simulate a medium-density screens such as the Motorola Droid 2::

    python main.py -m screens:droid2

To simulate a high-density screens such as HTC One X, in portrait::

    python main.py -m screens:onex,portrait

To simulate the iPad 2 screens::

    python main.py -m screens:ipad

If the generated window is too large, you can specify a scale::

    python main.py -m screens:note2,portrait,scale=.75
...
def apply_device(device, scale, orientation):
    ...
    Logger.info('Screen: Apply screens settings for {0}'.format(name))
...
def usage(device=None):
    if device:
        Logger.error('Screen: The specified device ({0}) is unknown.',
                     device)
    print('\nModule usage: python main.py -m screens:deviceid[,orientation]\n')
    ...
    for device, info in devices.items():
        print('{0:12} {1:<22} {2:<8} {3:<8} {4:<5} {5:<8}'.format(
            device, *info))
    print('\n')
    print('Simulate a medium-density screens such as Motorola Droid 2:\n')
    print('    python main.py -m screens:droid2\n')
    print('Simulate a high-density screens such as HTC One X, in portrait:\n')
    print('    python main.py -m screens:onex,portrait\n')
    print('Simulate the iPad 2 screens\n')
    print('    python main.py -m screens:ipad\n')
    print('If the generated window is too large, you can specify a scale:\n')
    print('    python main.py -m screens:note2,portrait,scale=.75\n')
    sys.exit(1)
