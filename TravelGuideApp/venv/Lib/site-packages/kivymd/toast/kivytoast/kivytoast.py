...
.. code-block:: python
    ...
    class Test(MDApp):
        def show_toast(self):
            '''Displays a toast on the screens.'''
...
class Toast(BaseDialog):
    ...
    """
    The amount of time (in seconds) that the toast is visible on the screens.
    ...
    def label_check_texture_size(
        ...
        """
        Resizes the text if the text texture is larger than the screens size.
    ...
    def fade_in(self) -> None:
        """Animation of opening toast on the screens."""
    ...
    def fade_out(self, *args) -> None:
        """Animation of hiding toast on the screens."""
...
def toast(
    ...
    :param duration: the amount of time (in seconds) that the toast is visible on the screens
