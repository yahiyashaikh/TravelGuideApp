...
.. code-block:: python
    ...
    class Example(MDApp):
        ...
        def set_list(self):
            async def set_list():
                ...
                for name_icon in names_icons_list:
                    ...
                    self.screens.ids.box.add_widget(
        ...
        def refresh_callback(self, *args):
            ...
            while the spinner remains on the screens.
            '''

            def refresh_callback(interval):
                self.screens.ids.box.clear_widgets()
                if self.x == 0:
                    self.x, self.y = 15, 30
                else:
                    self.x, self.y = 0, 15
                self.set_list()
                self.screens.ids.refresh_layout.refresh_done()
                self.tick = 0
