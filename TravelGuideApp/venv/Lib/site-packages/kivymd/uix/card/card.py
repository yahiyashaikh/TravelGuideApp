...
Binding a swipe to one of the sides of the screens
-------------------------------------------------
        ...
        .. code-block:: python
            ...
            class Example(MDApp):
                ...
                def remove_item(self, instance):
                    self.screens.ids.md_list.remove_widget(instance)

                def on_start(self):
                    for i in range(20):
                        self.screens.ids.md_list.add_widget(
                            SwipeToDeleteItem(text=f"One-line item {i}")
                        )
...
class MDCardSwipe(MDRelativeLayout):
    ...
    """
    Anchoring screens edge for card. Available options are: `'left'`, `'right'`.
