...
opening a calendar event from the home screens. Assist chips function as
...
.. code-block:: python
    ...
    class Example(MDApp):
        def __init__(self, **kwargs):
            ...
            self.screens = PreviewIconsScreen()
...
.. code-block:: python
    ...
    class Example(MDApp):
        ...
        def on_start(self) -> None:
            asynckivy.start(self.screens.create_chips())
