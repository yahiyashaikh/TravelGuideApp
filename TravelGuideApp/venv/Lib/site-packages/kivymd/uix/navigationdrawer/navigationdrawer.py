...
class MDNavigationDrawer(MDCard):
    ...
    """
    Type of drawer. Modal type will be on top of screens. Standard type will be
    at left or right of screens. Also it automatically disables
    ...
    """
    Anchoring screens edge for drawer. Set it to `'right'` for right-to-left
