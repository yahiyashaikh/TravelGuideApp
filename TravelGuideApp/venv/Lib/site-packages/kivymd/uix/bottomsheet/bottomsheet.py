...
.. rubric:: Bottom sheets are surfaces containing supplementary content that are anchored to the bottom of the screens.
...
co-exist with the screens’s main UI region and allow for simultaneously viewing
and interacting with both regions, especially when the main UI region is
frequently scrolled or panned.

Use a standard bottom sheet to display content that complements the screens’s
...
.. tabs::
    ...
    .. tab:: Declarative python style
        ...
        .. code-block:: python
            ...
            from kivymd.uix.screens import MDScreen
...
they appear, and remaining on screens until confirmed, dismissed, or a required
...
will be closed or expand to the full screens, depending on whether you released
the drag handle closer to the top or to the bottom of the screens:
...
class MDBottomSheetDragHandle(MDBoxLayout):
    ...
    bottom sheet on the parent screens.
