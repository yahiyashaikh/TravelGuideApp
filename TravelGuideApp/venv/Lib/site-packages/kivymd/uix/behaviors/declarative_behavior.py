...
.. code-block:: python
    ...
    class Example(MDApp):
        def build(self):
            ...
            data = {
                "screens 1": {"text": "Mail", "icon": "gmail"},
                "screens 2": {"text": "Discord", "icon": "discord"},
                "screens 3": {"text": "LinkedIN", "icon": "linkedin"},
            }
            ...
            screens.add_widget(bottom_navigation)
            return screens
...
We can quickly navigate through the components of the screens and quickly
