...
class MDTab(MDScreen):
    """
    A tab is simply a screens with meta information that defines the content
    that goes in the tab header.

    For more information, see in the
    :class:`~kivymd.uix.screens.MDScreen` class documentation.
    """
...
class MDBottomNavigation(DeclarativeBehavior, TabbedPanelBase):
    ...
    """
    Transition animation of bottom navigation screens manager.
    ...
    """
    Duration animation of bottom navigation screens manager.
