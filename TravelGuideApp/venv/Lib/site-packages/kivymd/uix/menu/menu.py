    ...
    class Test(MDApp):
        def __init__(self, **kwargs):
            ...
            self.menu = MDDropdownMenu(
                ...
                caller=self.screens.ids.button,
                items=menu_items,
            )
...
.. code-block:: python
    ...
    class Test(MDApp):
        def __init__(self, **kwargs):
            ...
            self.menu = MDDropdownMenu(
                caller=self.screens.ids.field,
                items=menu_items,
                position="bottom",
            )

        def set_item(self, text_item):
            self.screens.ids.field.text = text_item
            self.menu.dismiss()
...
.. code-block:: python
    ...
    class Test(MDApp):
        def __init__(self, **kwargs):
            ...
            self.menu = MDDropdownMenu(
                caller=self.screens.ids.drop_item,
                items=menu_items,
                position="center",
            )
            self.menu.bind()
        ...
        def set_item(self, text_item):
            self.screens.ids.drop_item.set_item(text_item)
            self.menu.dismiss()
