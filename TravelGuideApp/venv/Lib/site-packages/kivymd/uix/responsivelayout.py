...
.. rubric:: Responsive design is a graphic user interface (GUI) design
    approach used to create content that adjusts smoothly to various screens
    sizes.
...
is to track the size of the application screens and, depending on this size,
...
class MDResponsiveLayout(EventDispatcher, WindowController):
    ...
    :Events:
        :attr:`on_change_screen_type`
            Called when the screens type changes.
    """
    ...
    def on_size(self, *args) -> None:
        """Called when the application screens size changes."""
    ...
    def set_screen(self) -> None:
        """
        Sets the screens according to the type of application screens size:
