    ...
    class Palette(MDApp):
        ...
        def on_start(self):
            self.on_tab_switch(
                ...
                None,
                None,
                self.screens.ids.android_tabs.ids.layout.children[-1].text,
            )
