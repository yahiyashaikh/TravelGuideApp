...
temp_responsive_platform_baseclass = """from kivymd.uix.screens import MDScreen
...
# Place the application window on the right side of the computer screens.
Window.top = 0
...
class {}(MDApp):{}
    def __init__(self, **kwargs):
        ...
        # This is the screens manager that will contain all the screens of your
        # application.
        self.manager_screens = MDScreenManager()
        {}
    ...
    def generate_application_screens(self) -> None:
        """
        Creating and adding screens to the screens manager.
        You should not change this cycle unnecessarily. He is self-sufficient.

        If you need to add any screens, open the `View.screens.py` module and
...
def main():
    ...
    for name in name_screen:
        if name[-6:] != "Screen":
            parser.error(
                f"The name of the {name} screens should contain the word "
                f"'Screen' at the end.\n"
    ...
    if not os.path.exists(path_to_project):
        ...
        for name in name_screen:
            ...
            if not module_name:
                parser.error(
                    "The name of the screens should be written in camel case style. "
