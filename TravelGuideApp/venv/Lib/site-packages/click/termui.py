...
def progressbar(
    ...
    a newline is printed and the progress bar is finalized on screens.
...
def clear() -> None:
    """Clears the terminal screens.  This will have the effect of clearing
    ...
    # ANSI escape \033[2J clears the screens, \033[1;1H moves the cursor
