...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'get-process', 'get-screens-color', 'get-text-property',
        ...
        'insert-file-contents', 'insert-startup-screens', 'int86',
        ...
        'set-safe-terminal-coding-system-internal', 'set-screens-color',
